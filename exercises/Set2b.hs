...
countdown' int str
         | int < 1 = str ++ " Liftoff!"
         | otherwise = countdown' (int-1) (str ++ show int ++ "... ")
...
smallestDivisor' int num = if mod int num == 0 then num else smallestDivisor' int (num+1)

smallestDivisor :: Integer -> Integer
smallestDivisor int = smallestDivisor' int 2
...
isPrime int
        | int == 0 || int == 1 = False
        | otherwise = smallestDivisor int == int 
...
biggestPrimeAtMost' largest int num
                    | num > int = largest
                    | isPrime num && num <= int = biggestPrimeAtMost' num int (num + 1)
                    | otherwise =  biggestPrimeAtMost' largest int (num + 1)

biggestPrimeAtMost :: Integer -> Integer
biggestPrimeAtMost int = biggestPrimeAtMost' 2 int 2
